...
{
    public static InputDeviceDetector Instance { get; private set; }    // 싱글톤 객체
    ...
    /// </summary>
    public UnityEvent<InputDeviceType> InputDeviceChanged { get; private set; } = new UnityEvent<InputDeviceType>();
    ...
    private void SetCurrentInputDevice(InputDeviceType deviceType)
    {
        if (_currentInputDevice != deviceType)
        {
            ...
            InputDeviceChanged?.Invoke(_currentInputDevice);
        }
    }
