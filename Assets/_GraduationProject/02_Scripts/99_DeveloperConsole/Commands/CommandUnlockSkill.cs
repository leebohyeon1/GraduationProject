...
namespace Console
{
    public class CommandUnlockSkill : ConsoleCommand
    {
        ...
        public CommandUnlockSkill()
        {
            Name = "UnlockSkill";
            Command = "unlock-skill";
            Description = "Unlock a skill";
            Help = "Usage: unlock-skill <Skill Type>\n" +
