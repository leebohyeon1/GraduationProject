...
public class Task_ChasePlayerNode : Node
{
    ...
    public override void OnEnter()
    {
        ...
        // // BTDebug.Log(string.Format("[ChasePlayerNode : {0}] OnEnter 진입. 현재 상태: {1}, Lock: {2}", runner.name, runner.CurrentState, runner._stateController.IsStateLocked));
    ...
    {
        // // BTDebug.Log(string.Format("[ChasePlayerNode : {0}] OnExit 호출됨.", runner.name));
