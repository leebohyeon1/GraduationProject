...
public class Task_Discover_Player : Node
{
    ...
    public override void OnEnter()
    {
        ...
        _didSetLock = false;
        // // BTDebug.Log("[Task_Discover_Player : " + runner.name + "] 전투 돌입.");
    ...
    protected override NodeState OnUpdate()
    {
        ...
        {
            // // BTDebug.Log("[Task_EngageCombat : " + runner.name + "] 상태 이상으로 인한 중단.");
        ...
        {
            BTDebug.Log("[Task_EngageCombat : " + runner.name + "] 행동 종료 감지.");
        ...
        {
             BTDebug.Log("[Task_EngageCombat : " + runner.name + "] 타임아웃 종료.");
             return NodeState.SUCCESS;
        }
