	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 staticSwitch445 = v.ase_color;
				#else
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 staticSwitch447 = IN.ase_color;
				#else
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_BaseTexture4 = IN.ase_texcoord1.xy;
				float4 tex2DNode4 = tex2D( _BaseTexture, uv_BaseTexture4 );
...
Node;AmplifyShaderEditor.ColorNode;85;299.4533,2689.574;Inherit;False;Property;_DistanceFadeColor;Distance Fade Color;16;0;Create;True;0;0;0;False;0;False;0.5333334,0.6745098,0.1607843,1;0.5333334,0.6745098,0.1607843,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;316;629.4206,1772.451;Inherit;False;Property;_GroundFadeColor;Ground Fade Color;5;0;Create;True;0;0;0;False;0;False;0.3137255,0.3960785,0.1137255,1;0.3372549,0.4196079,0.145098,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=A66788C236F5639B077748F5BB786BE6A4EA7046